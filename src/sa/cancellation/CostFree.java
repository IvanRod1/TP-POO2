...
//		 * 
//		 * */
//		if(cancellationDate.isBefore(periodCancelled.start().minusDays(10))) {
//			System.out.println("No pagas nada");
//		}else {
//			System.out.println("Solo pagas el equivalente a dos dias de alquiler $:"+ booking.price(periodCancelled.start()) * 2 );
//		}
//		
//		
//	}
